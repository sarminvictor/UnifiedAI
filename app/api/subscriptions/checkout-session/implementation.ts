...
import { loadStripe, FALLBACK_PRICE_ID_FOR_TESTING } from "@/utils/subscriptions/stripe";

// Helper function to get a Stripe price ID from our updated utility
    ...
    try {
        ...
        await prisma.subscription.create({
            data: {
                ...
                stripe_info: `Pending|${checkoutSession.id}`
            }
        });
